...
class RJ_SocialIcons_Widget extends WP_Widget
{
    ...
    public function __construct()
    {
        parent::__construct(
            ...
            __('RJ: Social Icons', 'virtualwriter'), // Name
            array('description' => __('Social Icons', 'virtualwriter'),) // Args
        );
    }
...
?>
    ...
    public function form($instance)
    {
        if (isset($instance['title'])) {
            ...
            $title = __('Social Icons', 'virtualwriter');
        }
    ...
    ?>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php _e('Title:', 'virtualwriter'); ?></label>
            <input class="widefat" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" type="text" value="<?php echo esc_attr($title); ?>" />
        </p>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('classname')); ?>"><?php _e('CSS Class name:', 'virtualwriter'); ?></label>
        ...
        ?>
            <p>
                <label for="<?php echo esc_attr($this->get_field_id($sci)); ?>"><?php echo esc_html(ucfirst($sci) . " " . __('URL', 'virtualwriter')); ?>
                    : </label>
                <br />
...
function RJ_social_icons_widget()
{
    register_widget('RJ_SocialIcons_Widget');
}

add_action('widgets_init', 'RJ_social_icons_widget');
