...
$post_data = array();
while ($virtualwriter_fp->have_posts()) {
    $virtualwriter_fp->the_post();
...
if ($virtualwriter_fp->post_count > 1) :
?>
                        ...
                        <div class="entry__content">
                            ...
                            <div class="entry__info">
                                <a href="#0" class="entry__profile-pic">
                                    <img class="avatar" src="<?php echo esc_url($post_data[0]["author_avatar"]);  ?>" alt="author avatar">
                                </a>

                                <ul class="entry__meta">
                                    <li><a href="<?php echo esc_html($post_data[0]["author"]);  ?>"><?php echo esc_html($post_data[0]["author"]);  ?></a></li>
                    ...
                    ?>
                        ...
                        <div class="entry" style="background-image:url('<?php echo esc_url($post_data[$i]['thumbnail']); ?>');">
                            ...
                            <div class="entry__content">
                                ...
                                <div class="entry__info">
                                    <a href="#0" class="entry__profile-pic">
                                        <img class="avatar" src="<?php echo esc_url($post_data[$i]["author_avatar"]); ?>" alt="author avatar">
                                    </a>
